...
수학적 근거:
  Fixed 2:1 TP (sl_ratio=0.6은 SL 위치, 손실은 항상 -1.0R)
    - 승: +2.0R × risk, 패: -1.0R × risk
    - 손익분기 승률: 1/(1+2) = 33.3%
    - 40% 승률: EV = 0.40×2.0 - 0.60×1.0 = +0.20R/거래
    - 30% 승률: EV = 0.30×2.0 - 0.70×1.0 = -0.10R/거래
    - 6연패 확률(40%WR): 0.60^6 = 4.7%
    - 6연패 확률(30%WR): 0.70^6 = 11.8%
