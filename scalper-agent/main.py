"""
⚠️⚠️ DEAD — Kiwoom v1.0 데드코드 (실행 안 됨 · 진짜 봇 아님) ⚠️⚠️
====================================================================
★ 신규 세션/Codex/운영자 주의 (6/26 슬러지 H):
  이 파일은 옛 키움 Open API v1.0 진입점으로 통째 데드다.
  · 진짜 라이브 봇 = run_bot.py (KIS · mojito). 상세: DEAD_KIWOOM.md
  · api/kiwoom_* import · PyQt5+QAxWidget 키움 HTS 필요 · 계좌 없음 · 라이브 import 0건
  · '--mode live'가 있어도 실행 불가(키움 로그인 실패). 손대지 말 것.
====================================================================

Scalper Agent v1.0 - 단타 자동매매 (★ DEAD · 아래는 옛 키움 v1.0 문서)
====================================
