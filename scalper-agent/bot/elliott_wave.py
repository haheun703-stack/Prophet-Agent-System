...
# ── 5단계 피보 진입 셋팅 (★ 5/23 토 단타봇 fine-grained 2% grid 정밀화 ★) ─────
# 표본 285건 × 5파 성공 58건 = baseline 20.35%
#
# ★ 5/23 토 진짜 sweet spot 발견 — fine-grained 2% 스캔 ★
# 1위 36~46% (중심 41%): 표본  9건 / 성공률 55.6% (x2.73) / 평균수익 +30.1% / 기대 +16.7%
# 2위 38~48%           : 표본 12건 / 성공률 50.0% (x2.46) / 평균수익 +27.9% / 기대 +14.0%
# 3위 34~44%           : 표본  9건 / 성공률 44.4% (x2.18) / 평균수익 +31.2% / 기대 +13.9%
# 4위 32~42%           : 표본  7건 / 성공률 42.9% (x2.11) / 평균수익 +27.6% / 기대 +11.8%
# 5위 40~50%           : 표본 15건 / 성공률 40.0% (x1.97) / 평균수익 +35.4% / 기대 +14.2%
# 6위 50~60%           : 표본 16건 / 성공률 37.5% (x1.84) / 평균수익 +41.7% / 기대 +15.6%
#
# → 어제 fib_38_safe (28~48%) 46.7% → 5/23 정밀화 36~46% 55.6% (+8.9%p)
# → 외부 자료 "38.2%"는 1점 아닌 9건 범위 sweet (36-46%)이 진짜
#
# ★ 5/22 19:30 A+C 최적 조합 (zone × 룰 결합) ★
#   1. fib_38_safe + non_overlap=False → 75% (x3.69) — 표본 4건 (소수)
#   2. fib_38_safe + non_overlap=True → 66.7% (x3.28) — 표본 6건
#   ⚠️ alternation_check + sideways_w4 룰 = false negative → 제거
FIB_ZONES = [
    # (lo, hi, confidence, zone_name, signal)
    #  ★ 5/23 토 정밀화 결과 ★ — zone 이름은 호환 유지 (boost_with_metadata 의존)
    (36, 46,   1.0, "fib_38_safe",     "BUY"),         # ★★★ 진짜 sweet (55.6% x2.73) ★★★
    (46, 62,   0.7, "fib_50_standard", "BUY"),         # 차선 (46-50:40%, 50-60:37.5% 큰 수익)
    (62, 80,   0.1, "korean_low",      "AVOID"),       # ★ 회피 (9.1% 최악) ★
    (80, 100,  0.4, "trend_caution",   "BUY_CAUTION"), # 큰 수익 (+52.6%, 성공 20.6%)
    (100, 9999, 0.0, "trend_end",      "NO_ENTRY"),    # 추세 종료 (15.7일 시간 비용)
    (0,  36,   0.0, "too_shallow",     "NO_ENTRY"),    # ★ 5/23 확장 (이전 0-28 → 0-36)
                                                       #   28~36% 데이터 부족 → 보수 회피
]
