...
def get_candidate_score_map() -> Dict[str, int]:
    ...
    for code, sources in source_map.items():
        ...
        # ★ 5/24 검수 fix ★ KIS API 두 배 호출 제거 (today_change_map 재사용)
        today_chg = today_change_map.get(code, 0)
        if today_chg >= 25:
