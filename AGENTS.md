# Body Hunter v4 / Prophet Agent System — Codex Session Rules

> 이 파일은 **모든 Codex 세션 시작 시 자동 로드**됩니다.
...
- "Codex는 완벽하지 않습니다" 같은 disclaimer 문구 응답 끝에 **절대 X** (한국어/영어/어떤 언어든)
...
**Last updated**: 2026-05-25 (3-Tier 검수 룰 제정 + AGENTS.md 신설)
